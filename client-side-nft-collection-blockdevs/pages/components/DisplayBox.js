...
export default function textBox(props) {
  ...
  return (
    <div>
      <div className="p-6 max-w-sm bg-white rounded-xl shadow-lg flex items-center space-x-4 hover:shadow-md">
        ...
        <div>
          ...
          >
            <p className="text-slate-500 hover:text-black cursor-pointer">
